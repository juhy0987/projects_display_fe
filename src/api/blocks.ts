...
export function createBlock(
  ...
  return postJson<Block>(`/api/documents/${documentId}/blocks`, body);
}
...
export function patchBlock(
  ...
  return patchVoid(`/api/blocks/${blockId}`, fields);
}

export function deleteBlock(blockId: string): Promise<void> {
  return delVoid(`/api/blocks/${blockId}`);
}
...
export function changeBlockType(
  ...
  return patchVoid(`/api/blocks/${blockId}/type`, { type });
}
...
export function moveBlock(
  ...
  return patchVoid(`/api/blocks/${blockId}/position`, {
